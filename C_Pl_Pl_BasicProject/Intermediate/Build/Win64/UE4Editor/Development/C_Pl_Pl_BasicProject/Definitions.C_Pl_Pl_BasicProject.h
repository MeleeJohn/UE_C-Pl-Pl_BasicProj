#undef C_PL_PL_BASICPROJECT_API
...
#define UE_PROJECT_NAME C_Pl_Pl_BasicProject
#define UE_TARGET_NAME C_Pl_Pl_BasicProjectEditor
#define UE_MODULE_NAME "C_Pl_Pl_BasicProject"
...
#define C_PL_PL_BASICPROJECT_API DLLEXPORT
